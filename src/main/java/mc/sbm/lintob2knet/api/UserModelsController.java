...
public class UserModelsController {
    ...
    @PostMapping
    public ResponseEntity<Map<String, String>> post(@PathVariable String conveyorCode, @Valid @RequestBody UserModelTransaction dto) {
        String normalizedConveyor = conveyorValidator.normalize(conveyorCode);

        log.debug(
            "Received user-model import request: transactionId={}, userNumber={}, itemCode={}, conveyor={}",
            dto.getId(),
            dto.getUserNumber(),
            dto.getItemCode(),
            normalizedConveyor
        ...
        try {
            ...
            log.info(
                "User-model import event sent successfully: transactionId={}, userNumber={}, itemCode={}, conveyor={}, topic={}, key={}",
                dto.getId(),
                dto.getUserNumber(),
                dto.getItemCode(),
                normalizedConveyor,
            ...
            log.error(
                "Failed to send user-model import event: transactionId={}, userNumber={}, itemCode={}, conveyor={}",
                dto.getId(),
                dto.getUserNumber(),
                dto.getItemCode(),
                normalizedConveyor,
